...
$(document).ready(function() {
    html = '<h2><i class="wi wi-owm-900"><span style="font-size: 30px;">&nbsp;</span></i></h2>';
    html += '<h2><i class="wi wi-owm-day-900"><span style="font-size: 30px;">&nbsp;</span></i></h2>';
    html += '<h2><i class="wi wi-owm-night-900"><span style="font-size: 30px;">&nbsp;</span></i></h2>';
    $("#weather").html(html);
